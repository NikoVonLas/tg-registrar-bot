...
- Documentation:
  ...
  - API - Complete command and callback reference
...
See [CONTRIBUTING.en.md](./CONTRIBUTING.en.md) for guidelines on proposing changes and submitting pull requests.

---

## Support

- **Documentation:** See README.en.md and other docs
